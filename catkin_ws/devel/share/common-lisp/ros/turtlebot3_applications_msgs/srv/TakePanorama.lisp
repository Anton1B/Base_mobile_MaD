...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TakePanorama-request>)))
  ...
  (cl:format cl:nil "~%~%~%uint8 SNAPANDROTATE=0~%uint8 CONTINUOUS=1~%uint8 STOP=2~%~%uint8 STARTED=0~%uint8 IN_PROGRESS=1~%uint8 STOPPED=2~%~%~%~%~%uint8 mode~%float32 pano_angle~%float32 snap_interval~%float32 rot_vel~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TakePanorama-request)))
  "Returns full string definition for message of type 'TakePanorama-request"
  (cl:format cl:nil "~%~%~%uint8 SNAPANDROTATE=0~%uint8 CONTINUOUS=1~%uint8 STOP=2~%~%uint8 STARTED=0~%uint8 IN_PROGRESS=1~%uint8 STOPPED=2~%~%~%~%~%uint8 mode~%float32 pano_angle~%float32 snap_interval~%float32 rot_vel~%~%~%"))
